...
namespace ServicioTumoresBackend.EntityFrameworkCore.Seed.Host
{
    public class DefaultLanguagesCreator
    {
        ...
        {
            var tenantId = ServicioTumoresBackendConsts.MultiTenancyEnabled ? null : (int?)MultiTenancyConsts.DefaultTenantId;
        ...
        public DefaultLanguagesCreator(ServicioTumoresBackendDbContext context)
        {
            _context = context;
        }
