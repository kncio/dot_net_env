...
using Shouldly;
using Xunit;
using ServicioTumoresBackend.Sessions;

namespace ServicioTumoresBackend.Tests.Sessions
{
    public class SessionAppService_Tests : ServicioTumoresBackendTestBase
    {
